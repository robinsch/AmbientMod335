...
AmbientModPanelOptions = {
	...
	ambientShade = { text = "Ambient Darkness", minValue = 0.05, maxValue = 1, valueStep = 0.005, },
	...
	overrideDayProgress = { text = "Time Progress", minValue = 0.005, maxValue = 1.0, valueStep = 0.005, },
}
